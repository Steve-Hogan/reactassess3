    ...
    <div className='container'>
      {next ? null :
        <form action="" onSubmit={submitHandler}>
          ...
          <label>Name : </label>
          <input className='inputbtn' type="text" name="userName" value={data.userName} onChange={userHandler} />
          </div>
          <div className="sub_container">
          <label>Department : </label>
          <input className='inputbtn'  type="text" name="dept" value={data.dept} onChange={userHandler} />
          </div>
          <div className="sub_container">
          <label>Rating : </label>
          <input className='inputbtn'  type="text" name="rate" value={data.rate} onChange={userHandler} />
          </div> 
